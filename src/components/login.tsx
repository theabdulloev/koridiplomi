...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col p-4 justify-center items-center mx-auto space-y-2 h-[70vh]">
      <Card className="max-w-[540px] w-full h-full max-h-[700px]">
        ...
        <CardBody className="overflow-hidden h-full">
          ...
          >
            <Tab key="login" className=" h-full" title="Ворид шудан">
            ...
            <Tab key="sign-up" className=" h-full" title="Аз қайд гузаштан">
